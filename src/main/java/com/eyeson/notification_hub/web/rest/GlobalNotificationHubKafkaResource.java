...
@RestController
@RequestMapping("/api/global-notification-hub-kafka")
public class GlobalNotificationHubKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GlobalNotificationHubKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GlobalNotificationHubKafkaResource(KafkaProperties kafkaProperties) {
